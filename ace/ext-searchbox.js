    ...
    ace.define("ace/ext/searchbox", [
        ...
        var c = function () {
                function e(e, t, n) {
                    this.activeInput,
                        this.element = r.buildDom(["div", {
                            ...
                            "class": "ace_searchbtn",
                            title: "Alt-Enter",
                        }, f("search-box.find-all.text", "All")]], ["div", {
                            "class": "ace_replace_form",
                        }, ["input", {
                            "class": "ace_search_field",
                            placeholder: f(
                                "search-box.replace.placeholder",
                                "Replace with",
                            ),
                            spellcheck: "false",
                        }], ["span", {
                            ...
                            "class": "ace_searchbtn",
                        }, f("search-box.replace-next.text", "Replace")], [
                            "span",
                            { action: "replaceAll", "class": "ace_searchbtn" },
                            f("search-box.replace-all.text", "All"),
                        ]], [
                            "div",
                            ...
                            ["span", {
                                ...
                                "class": "ace_button",
                                title: f(
                                    "search-box.toggle-regexp.title",
                                    "RegExp Search",
                                ),
                            }, ".*"],
                            ["span", {
                            ...
                            ["span", {
                                ...
                                "class": "ace_button",
                                title: f(
                                    "search-box.toggle-in-selection.title",
                                    "Search In Selection",
                                ),
                            }, "S"],
                        ]]),
                        ...
                        s.addListener(this.element, "touchstart", function (e) {
                            e.stopPropagation();
                        }, e);
                }
                return e.prototype.setEditor = function (e) {
                    ...
                    e.prototype.onEditorInput = function () {
                        this.find(!1, !1, !0);
                    },
                    e.prototype.$initElements = function (e) {
                        this.searchBox = e.querySelector(".ace_search_form"),
                            ...
                            this.replaceOption = e.querySelector(
                                "[action=toggleReplace]",
                            ),
                            ...
                            this.searchCounter = e.querySelector(
                                ".ace_search_counter",
                            );
                    },
                    ...
                    e.prototype.setSearchRange = function (e) {
                        this.searchRange = e,
                            e
                                ? this.searchRangeMarker = this.editor.session
                                    .addMarker(e, "ace_active-line")
                    ...
                    e.prototype.$syncOptions = function (e) {
                        r.setCssClass(
                            this.replaceOption,
                            "checked",
                            this.searchRange,
                            ...
                            this.replaceOption.textContent =
                                this.replaceOption.checked ? "-" : "+",
                            r.setCssClass(
                                this.regExpOption,
                                "checked",
                    ...
                    e.prototype.updateCounter = function () {
                        var e = this.editor,
                            ...
                            s = 0;
                        if (t) {
                            var o = this.searchRange
                                ? e.session.getTextRange(this.searchRange)
                                : e.getValue();
                            e.$search.$isMultilineSearch(
                                e.getLastSearchOptions(),
                            ) &&
                                (o = o.replace(/\r\n|\r|\n/g, "\n"),
                                    e.session.doc.$autoNewLine = "\n");
                            var u = e.session.doc.positionToIndex(
                                e.selection.anchor,
                            );
                            this.searchRange &&
                                (u -= e.session.doc.positionToIndex(
                                    this.searchRange.start,
                                ));
                            var a = t.lastIndex = 0, c;
                            while (c = t.exec(o)) {
                                r++, a = c.index, a <= u && s++;
                                if (r > l) break;
                                if (!c[0]) {
                                    t.lastIndex = a += i.skipEmptyMatch(
                                        o,
                                        a,
                                        n,
                                    );
                        ...
                        this.searchCounter.textContent = f(
                    ...
                    e.prototype.replaceAndFindNext = function () {
                        this.editor.getReadOnly() ||
                            (this.editor.replace(this.replaceInput.value),
                                this.findNext());
                    },
                    ...
                    e.prototype.show = function (e, t) {
                        this.active = !0,
                            ...
                            this.editor.$search.$options.regExp &&
                            (e = i.escapeRegExp(e)),
                            e != undefined && (this.searchInput.value = e),
        ...
        c.prototype.$searchBarKb = h,
            c.prototype.$closeSearchBarKb = p,
            t.SearchBox = c,
            t.Search = function (e, t) {
                var n = e.searchBox || new c(e),
                    r = e.session.selection.getRange(),
                    i = r.isMultiLine() ? "" : e.session.getTextRange(r);
                n.show(i, t);
            };
    });
(function () {
